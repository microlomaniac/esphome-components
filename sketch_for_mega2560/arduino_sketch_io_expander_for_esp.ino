...
// ADDR1 and ADDR0 have pullup resistors and jumpers, when jumper is ON pin gets pulled to GND
...
#define I2C_ADDR_PIN1_SHIFT 2
#define I2C_ADDR_PIN0_SHIFT 1
#define I2C_ADDR_PIN1 0
#define I2C_ADDR_PIN0 1
...
void setup()
{
  ...
  int i2cAddr = 8;
  pinMode(I2C_ADDR_PIN1, INPUT_PULLUP);
  pinMode(I2C_ADDR_PIN0, INPUT_PULLUP);
  if (digitalRead(I2C_ADDR_PIN1) == LOW)
  {
    //i2cAddr |= 1 << I2C_ADDR_PIN1_SHIFT;
    i2cAddr += 4;
  }
  if (digitalRead(I2C_ADDR_PIN0) == LOW)
  {
    //i2cAddr |= 1 << I2C_ADDR_PIN0_SHIFT;
    i2cAddr += 2;
  }
